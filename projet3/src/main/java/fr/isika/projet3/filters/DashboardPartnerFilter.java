...
public class DashboardPartnerFilter implements Filter {
	public static final String ACCESS_CONNEXION  = "/connexionPartner";
    public static final String ATT_SESSION_PARTNER = "sessionPartner";
...
//        System.out.println(session.getAttribute(ATT_SESSION_ASSOCIATION));
         ...
         */
        if (session.getAttribute(ATT_SESSION_PARTNER) == null) {
